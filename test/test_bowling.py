...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_strike_and_spare_score_calculation(self):
        game = BowlingGame()
        game.add_frame(Frame(10,0))
    ...
    def test_strike_followed_by_strike_score_calculation(self):
        game = BowlingGame()
        game.add_frame(Frame(10,0))
        game.add_frame(Frame(10,0))
        game.add_frame(Frame(7,2))
    ...
    def test_calculate_score_multiple_spares(self):
        game = BowlingGame()
    ...
    def test_spare_as_the_last_frame(self):
        game = BowlingGame()
        game.add_frame(Frame(1,5))
        game.add_frame(Frame(3,6))
        game.add_frame(Frame(7,2))
